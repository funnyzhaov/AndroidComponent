package com.xuexibaoapp.educhain.xuelian;
...
import com.xuexibaoapp.educhain.photo.load.XLImageLoad;
...
public class AppStartActivity extends BaseActivity {
	...
	private void loadAni(){
		XLImageLoad.getInstance().loadGif(this, com.xuexibaoapp.educhain.photo.R.drawable.photo_app_start,mIvGif);
	}
